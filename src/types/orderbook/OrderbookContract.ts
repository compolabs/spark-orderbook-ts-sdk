...
export type OrderbookContractConfigurables = Partial<{
  OWNER: AddressInput;
...
const abi = {
  ...
  "concreteTypes": [
    ...
    {
      "type": "enum errors::OrderbookError",
      "concreteTypeId": "3eb547542e0a8ac0ab5f91b2d15e72cf26f90968c806b45aa65ce22c3efa1f4d",
      "metadataTypeId": 5
    },
    {
...
export class OrderbookContractInterface extends Interface {
  constructor() {
    super(abi);
  }
...
export class OrderbookContract extends Contract {
  ...
  declare interface: OrderbookContractInterface;
  declare functions: {
